...
API_TOKEN = os.getenv("BOT_TOKEN")  # <-- BOT TOKEN shu yerga .env orqali keladi
...
ADMIN_ID = 983517327   # <-- bu yerga o'z Telegram ID'ingni qo'yasan
...
async def show_day(callback: CallbackQuery):
    ...
    # ✅ faqat 4-kunda to‘lov
    if day == 4 and 4 not in user.get("paid_days", []):
        await callback.message.edit_text(
            get_payment_text(weight, day),
